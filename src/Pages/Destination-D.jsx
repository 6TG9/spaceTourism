...
import titan from "../../public/images/Titan.png";
        ...
        <div className="flex flex-col items-center md:items-start">
          ...
          >
            <NavLink
              to="/Destination-A"
              className={({ isActive }) =>
                `pb-2 ${isActive ? "border-b-2 border-white text-white" : ""}`
              }
            >
              MOON
            </NavLink>
          ...
          <div className="flex flex-col gap-6 text-center md:flex-row md:gap-24 md:text-left">
            <div>
              ...
              <p className="text-[#FFFFFF] text-[28px]">1.6 BIL. km</p>
            </div>
            <div>
              <p className="text-[#D0D6F9] text-[14px] md:text-[16px] tracking-widest">
                Est. travel time
              </p>
              <p className="text-[#FFFFFF] text-[28px]">7 years</p>
            </div>
          </div>
        </div>
      </div>
